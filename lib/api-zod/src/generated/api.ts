...
export const RegenerateQuestionBody = zod.object({
  "difficulty": zod.enum(['easy', 'medium', 'hard']).optional(),
  "questionType": zod.enum(['multiple_choice', 'true_false', 'write_in', 'multi_select', 'ordering']).optional()
})
...
export const ListGameQuestionsResponseItem = zod.object({
  ...
  "gameId": zod.number(),
  "questionText": zod.string(),
  "questionType": zod.enum(['multiple_choice', 'write_in', 'matching', 'image_recognition', 'true_false', 'multi_select', 'ordering']),
...
export const UpdateQuestionBody = zod.object({
  ...
  "questionType": zod.enum(['multiple_choice', 'write_in', 'matching', 'image_recognition', 'true_false', 'multi_select', 'ordering']).optional(),
