 ...
 * by the game creation/update routes (4–12 alphanumeric characters).
 */

// ── Admin code ────────────────────────────────────────────────────────────────

/** Minimum entropy boundary for host-selected player room codes. */
export const MIN_GAME_ACCESS_CODE_LENGTH = 4;
export const MAX_GAME_ACCESS_CODE_LENGTH = 12;
export const GAME_ACCESS_CODE_PATTERN = /^[A-Za-z0-9]{4,12}$/;
